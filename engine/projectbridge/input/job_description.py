...
class JobRequirements(BaseModel):
    ...
    architectural_expectations: list[str] = Field(
        description="Architectural patterns or practices expected (e.g. 'microservices', 'CI/CD').",
    )
...
TECHNOLOGY_KEYWORDS: dict[str, str] = {
    ...
    "kotlin": "Kotlin", "scala": "Scala", "r": "R", "sql": "SQL",
    # Frontend
    "react": "React", "reactjs": "React", "react.js": "React",
    "angular": "Angular", "vue": "Vue", "vuejs": "Vue", "vue.js": "Vue",
    ...
    "google cloud": "GCP", "terraform": "Terraform",
    "ansible": "Ansible", "jenkins": "Jenkins",
    "github actions": "GitHub Actions", "gitlab ci": "GitLab CI",
    "linux": "Linux", "nginx": "Nginx",
    # Tools
    "git": "Git", "webpack": "Webpack", "vite": "Vite",
    "jest": "Jest", "pytest": "pytest", "selenium": "Selenium",
    "redux": "Redux", "rabbitmq": "RabbitMQ",
}
...
DOMAIN_KEYWORDS: dict[str, str] = {
    ...
    "full-stack": "full-stack", "full stack": "full-stack", "fullstack": "full-stack",
    ...
    "api development": "API development", "api design": "API development",
    "database": "database", "data modeling": "database",
    "testing": "testing", "qa": "testing", "quality assurance": "testing",
    "distributed systems": "distributed systems",
    "embedded": "embedded systems", "embedded systems": "embedded systems",
...
ARCHITECTURE_KEYWORDS: dict[str, str] = {
    ...
    "graphql": "GraphQL",
    "soa": "SOA", "service-oriented": "SOA",
    "mvp": "MVP", "mvc": "MVC", "mvvm": "MVVM",
    "single page application": "SPA", "spa": "SPA",
    "ssr": "SSR", "server-side rendering": "SSR",
    "containerization": "containerization",
    "infrastructure as code": "infrastructure as code", "iac": "infrastructure as code",
    "observability": "observability", "monitoring": "observability",
