...
TAXONOMY: dict[str, tuple[SkillCategory, list[str]]] = {
    ...
    "Python": (SkillCategory.LANGUAGE, [
        "Django", "Flask", "FastAPI", "pytest", "Celery", "NumPy", "Pandas",
    ]),
    "JavaScript": (SkillCategory.LANGUAGE, [
        "TypeScript", "React", "Vue", "Angular", "Node.js", "Express",
    ]),
    "TypeScript": (SkillCategory.LANGUAGE, [
        "JavaScript", "React", "Angular", "Node.js", "Next.js",
    ]),
    "Java": (SkillCategory.LANGUAGE, [
        "Spring", "Spring Boot", "Kotlin", "Maven", "Gradle",
    ]),
    ...
    "CSS": (SkillCategory.LANGUAGE, [
        "HTML", "Sass", "Tailwind CSS",
    ]),

    # --- Frontend Frameworks -----------------------------------------------
    "React": (SkillCategory.FRAMEWORK, [
        "Next.js", "Redux", "TypeScript", "React Native", "Vite",
    ]),
    "Vue": (SkillCategory.FRAMEWORK, [
        "Nuxt", "Vuex", "TypeScript", "Vite",
    ]),
    ...
    "Django": (SkillCategory.FRAMEWORK, [
        "Python", "PostgreSQL", "Celery", "Django REST Framework",
    ]),
    ...
    "Spring Boot": (SkillCategory.FRAMEWORK, [
        "Java", "Spring", "Kotlin", "Maven", "Gradle",
    ]),
    ...
    "Fastify": (SkillCategory.FRAMEWORK, [
        "Node.js", "TypeScript",
    ]),

    # --- Databases ---------------------------------------------------------
    "PostgreSQL": (SkillCategory.INFRASTRUCTURE, [
        "SQL", "Redis", "Django",
    ]),
    "MySQL": (SkillCategory.INFRASTRUCTURE, [
        "SQL", "PHP", "Laravel",
    ]),
    "MongoDB": (SkillCategory.INFRASTRUCTURE, [
        "Node.js", "Express", "Mongoose",
    ]),
    "Redis": (SkillCategory.INFRASTRUCTURE, [
        "PostgreSQL", "Celery", "Caching",
    ]),
    "SQLite": (SkillCategory.INFRASTRUCTURE, [
        "SQL", "Python",
    ]),
    "Elasticsearch": (SkillCategory.INFRASTRUCTURE, [
        "Kibana", "Logstash",
    ]),
    ...
    "Docker Compose": (SkillCategory.INFRASTRUCTURE, [
        "Docker", "Kubernetes",
    ]),
    "Kubernetes": (SkillCategory.INFRASTRUCTURE, [
        "Docker", "Helm", "Terraform", "AWS",
    ]),
    "Terraform": (SkillCategory.INFRASTRUCTURE, [
        "AWS", "GCP", "Azure", "Kubernetes",
    ]),
    "AWS": (SkillCategory.INFRASTRUCTURE, [
        "Terraform", "Docker", "Kubernetes", "Lambda",
    ]),
    "GCP": (SkillCategory.INFRASTRUCTURE, [
        "Terraform", "Docker", "Kubernetes",
    ]),
    "Azure": (SkillCategory.INFRASTRUCTURE, [
        "Terraform", ".NET", "C#",
    ]),
    "GitHub Actions": (SkillCategory.INFRASTRUCTURE, [
        "Docker", "CI/CD", "Git",
    ]),
    "GitLab CI": (SkillCategory.INFRASTRUCTURE, [
        "Docker", "CI/CD", "Git",
    ]),
    "Jenkins": (SkillCategory.INFRASTRUCTURE, [
        "Docker", "CI/CD", "Groovy",
    ]),
    "Ansible": (SkillCategory.INFRASTRUCTURE, [
        "Terraform", "Linux", "Docker",
    ]),
    "Nginx": (SkillCategory.INFRASTRUCTURE, [
        "Linux", "Docker", "Load Balancing",
    ]),
    "Linux": (SkillCategory.INFRASTRUCTURE, [
        "Docker", "Bash", "Nginx",
    ]),
    "Helm": (SkillCategory.INFRASTRUCTURE, [
        "Kubernetes", "Docker",
    ]),

    # --- Messaging & Streaming ---------------------------------------------
    "Kafka": (SkillCategory.INFRASTRUCTURE, [
        "Event-Driven Architecture", "Microservices", "Java",
    ]),
    "RabbitMQ": (SkillCategory.INFRASTRUCTURE, [
        "Microservices", "Celery", "Event-Driven Architecture",
    ]),
